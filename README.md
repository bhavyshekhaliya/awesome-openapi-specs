...
| Factorial | [OpenAPI specification](https://api.factorialhr.com/oas/)                                      | JSON       | 3.1.0    | `official` `hris` `time-tracking`                         |
| Gadjian   | [OpenAPI specification](https://developer.gadjian.com/docs/swagger.yaml)                       | YAML       | 3.0.1    | `official` `hris` `payroll`                               |
| Happily.ai | [OpenAPI specification](https://developer.happily.ai/openapi.yaml)                             | YAML       | 3.1.0    | `official` `hr` `employee-engagement`                     |
| HRlab     | [OpenAPI documentation](https://api-doc.hrlab.de/)                                            | YAML       | 3.1.0    | `official` `hris` `payroll` `time-tracking`                |
| Hrider    | [OpenAPI specification](https://dev.hrider.net/api/openapi.json)                               | JSON       | 3.0.1    | `official` `hris` `employee-management`                   |
| oHRis     | [OpenAPI specification](https://api.ohris.info/openapi/ohris_redoc.json)                       | JSON       | 3.0.0    | `official` `hris` `absence-management`                    |
| Personio  | [API specifications](https://github.com/personio/api-docs)                                     | YAML, JSON | 3.0.0    | `official` `hris` `recruiting`                             |
...
| Square   | [API specification](https://github.com/square/connect-api-specification)           | JSON       | 3.0     | `official` `platform` `payments` `commerce` `point-of-sale` |
